...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-sm-4">
                <?php
                $data = array('name' => 'first_name', 'label' => 'First Name', 'placeholder' => 'First Name', 'class' => 'form-control', 'value' => set_value('first_name', $first_name));
        ...
        <div class="row">
            <div class="col-sm-4">
                <?php
                $data = array('name' => 'last_name', 'label' => 'Last Name', 'placeholder' => 'Last Name', 'class' => 'form-control', 'value' => set_value('last_name', $last_name));
                echo form_input_1($data);
                ?>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                echo form_dropdown('admin_role_id', $options, set_value('admin_role_id', $role_id), 'class="form-control"');
                ?>
            </div>
        </div>
        <div class="row">
...
<div class="row" style="margin-top: 15px">
    <div class="col-sm-4">
        ...
        <a class="btn btn-outline-gray" href="<?php echo site_url($this->admin_folder . '/' . $this->controller_dir . '/users/user.html'); ?>">Back</a>
    </div>
</div>
