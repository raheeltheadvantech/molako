...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <div class="col-md-12">
                    <h4>Paypal API Integration settings</h4>
                    <hr>
                    <div class="form-group">
                        <label>Mode</label>
                        <?php
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="col-md-12">
                            ...
                            <hr>
                            <?php
                            $data = array('name' => $sandbox_username_name, 'label' => 'Paypal sandbox username', 'placeholder' => 'Paypal sandbox username', 'class' => 'form-control', 'value' => set_value($sandbox_username_name, $sandbox_username));
                            echo form_input_1($data);
                            ?>
                        </div>
                        <div class="col-md-12">
                            <?php
                            $data = array('name' => $sandbox_password_name, 'label' => 'Paypal sandbox password', 'placeholder' => 'Paypal sandbox password', 'class' => 'form-control', 'value' => set_value($sandbox_password_name, $sandbox_password));
                            echo form_input_1($data);
                            ?>
                        </div>
                        <div class="col-md-12">
                            <?php
                            $data = array('name' => $sandbox_api_signature_name, 'label' => 'Paypal sandbox signature', 'placeholder' => 'Paypal sandbox signature', 'class' => 'form-control', 'value' => set_value($sandbox_api_signature_name, $sandbox_api_signature));
                            echo form_input_1($data);
                            ?>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="col-md-12">
                            ...
                            <hr>
                            <?php
                            $data = array('name' => $live_username_name, 'label' => 'Paypal live username', 'placeholder' => 'Paypal live username', 'class' => 'form-control', 'value' => set_value($live_username_name, $live_username));
                            echo form_input_1($data);
                            ?>
                        </div>
                        <div class="col-md-12">
                            <?php
                            $data = array('name' => $live_password_name, 'label' => 'Paypal live password', 'placeholder' => 'Paypal live password', 'class' => 'form-control', 'value' => set_value($live_password_name, $live_password));
                            echo form_input_1($data);
                            ?>
                        </div>
                        <div class="col-md-12">
                            <?php
                            $data = array('name' => $live_api_signature_name, 'label' => 'Paypal live signature', 'placeholder' => 'Paypal live signature', 'class' => 'form-control', 'value' => set_value($live_api_signature_name, $live_api_signature));
                            echo form_input_1($data);
                            ?>
                        </div>
                    </div>
