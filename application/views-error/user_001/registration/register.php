                    ...
                    <div class="customer-inner" style="border: none;">
                        ...
                        <div class="account-form contact-form">
                            ...
                            <div class="form-goroup">
                                <?php echo form_input_1(array('name'=>'first_name', 'label'=>'First name *', 'class'=>'form-control', 'value'=>set_value('first_name', $first_name))); ?>
                            </div>
                            <div class="form-goroup">
                                <?php echo form_input_1(array('name'=>'last_name', 'label'=>'Last name *',  'class'=>'form-control', 'value'=>set_value('last_name', $last_name))); ?>
                            </div>
                            <div class="form-goroup">
                                <?php echo form_input_1(array('name'=>'email', 'label'=>'Email *', 'class'=>'form-control', 'value'=>set_value('email', $email))); ?>
                            </div>
                            <div class="form-goroup">
                                <?php echo form_input_1(array('name'=>'phone', 'label'=>'Phone *', 'class'=>'form-control', 'value'=>set_value('phone', $phone))); ?>
                            </div>
                            <div class="form-goroup">
