...
<div class="tf-mini-cart-btns">
                                                ...
                                                <div class="tf-mini-cart-remove"  onclick="remove_cart('<?php echo $product->product_id; ?>')">Remove</div>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                        ...
                        <div class="tf-mini-cart-bottom">
                            ...
                            <div class="tf-mini-cart-bottom-wrap">
                                ...
                                <div class="tf-mini-cart-view-checkout">
                                    ...
                                    <a href="<?= base_url('checkout/shipping.html'); ?>" class="tf-btn btn-fill animate-hover-btn radius-3 w-100 justify-content-center"><span>Check out</span></a>
                                </div>
                            </div>
                        </div>
