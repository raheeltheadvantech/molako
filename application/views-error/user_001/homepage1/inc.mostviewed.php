...
<div class="product-view">
    <div id="mostviewed-carousel" class="owl-carousel custom-carousel">
        <?php
        if(isset($most_view_products) && !empty($most_view_products)){
            foreach ($most_view_products as $val) {?>
                        ...
                        <div class="single-product-content">
                            ...
                            <div class="product-actions">
                                ...
                                <div class="add-to-link">
                                    <ul class="">
                                        <li class="quic-view"><button type="button" data-bs-target="#productModal-most-<?php echo $val->product_id; ?>" data-bs-toggle="modal"><i class="fa fa-search"></i>Quick view</button></li>
...
<?php if(isset($most_view_products) && !empty($most_view_products)){
    foreach ($most_view_products as $val) {?>
        <div id="quickview-wrapper">
            <div class="modal fade productModaal" id="productModal-most-<?php echo $val->product_id; ?>">
