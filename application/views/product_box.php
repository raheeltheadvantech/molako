<div class="card-product style-skincare">
                                    ...
                                    ?>
                                                        <img class="img-product pbox ls-is-cached lazyloaded" data-src="<?= live_img_url().'/images/image.php?width=400&height=400&image=/'.$img; ?>" src="<?= live_img_url().'/images/image.php?width=400&height=400&image=/'.$img; ?>" alt="image-product">
                                                        <img class="img-hover pbox ls-is-cached lazyloaded" data-src="<?= live_img_url().'/images/image.php?width=400&height=400&image=/'.$img1; ?>" src="<?= live_img_url().'/images/image.php?width=400&height=400&image=/'.$img1; ?>" alt="image-product">
                                                    </a>
                                                    <div class="list-product-btn">
                                <a 

                                                        <?php 
                                                        if((isset($product->varient_id) && $product->varient_id))
                                                        {

                                                        echo 'href="'.href_product($product).'"';
                                                        }
                                                        else
                                                        {
                                                            ?>
                                                            onclick="quick_add('<?php echo $product->product_id ?>','1','<?= (isset($product->varient_id)?$product->varient_id:0) ?>')"
                                ...
                                ?>
                                                    <div class="tf-product-btns">
                                                        ...
                                                        else
                                                        {
                                                         ...
                                                         ?>  class="quick-add tf-btn style-3 radius-3 btn-fill animate-hover-btn"><?php echo (isset($product->varient_id) && $product->varient_id)?'Select Shade':' Add to cart'; ?></a>
                                                    </div>
                                                </div>
                                            </div>