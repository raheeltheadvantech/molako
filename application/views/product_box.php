                                ...
                                ?>
                                                    <div class="tf-product-btns">
                                                        ...
                                                        else
                                                        {
                                                         ...
                                                         ?>  class="quick-add tf-btn style-3 radius-3 btn-fill animate-hover-btn"><?php echo (isset($product->option_value) && $product->option_value)?'Select Shade':' Add to cart'; ?></a>
                                                    </div>
                                                </div>
                                            </div>