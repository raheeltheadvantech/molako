            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group" style="padding-top: 19px;">
                        <a href="<?php echo site_url('checkout/shipping/address.html')?>" class="tf-btn w-10 radius-3 btn-fill animate-hover-btn justify-content-center"><i class="fa fa-plus"> Add</i></a>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group" style="margin-bottom: 15px;">
