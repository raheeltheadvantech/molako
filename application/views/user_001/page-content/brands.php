                            ...
                            <div class="tf-content-brands">
                            	<?php
                                    ...
                                    <a href="<?php echo base_url(); ?>catalog.html?brand_id=<?php echo $v['brand_id']; ?>">
                                        ...
                                        <img src="<?= live_img_url().'images/image.php?width=400&height=400&image=/images/brands/thumbnails/'.$v['images']; ?>" alt="">
                                        <?php
                                    	}

                                    	?>
                                    </a>
                                    <a href="<?php echo live_img_url(); ?>catalog.html?brand_id=<?php echo $v['brand_id']; ?>"><?= $v['name'] ?></a>
                                </div>
