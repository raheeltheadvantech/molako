...
<div class="product-view">
    <div id="special-carousel" class="owl-carousel custom-carousel">
    <?php if(isset($special_products) && !empty($special_products)){
    foreach ($special_products as $val) {?>
                ...
                <div class="single-product-content">
                    ...
                    <div class="product-actions">
                        ...
                        <div class="add-to-link">
                            <ul class="">
                                <li class="quic-view"><button type="button" data-bs-target="#productModal-spec-<?php echo $val->product_id; ?>" data-bs-toggle="modal"><i class="fa fa-search"></i>Quick view</button></li>
...
if(isset($special_products) && !empty($special_products)){
    foreach ($special_products as $val) {?>
        <div id="quickview-wrapper">
            <div class="modal fade productModaal" id="productModal-spec-<?php echo $val->product_id; ?>">
