...
<div class="product-view">
    <div id="laptop-carousel-2" class="owl-carousel custom-carousel">
        <?php
        if(isset($new_arrival_products) && !empty($new_arrival_products)){
        foreach ($new_arrival_products as $val) {?>
                    ...
                    <div class="single-product-content">
                        ...
                        <div class="product-actions">
                            ...
                            <div class="add-to-link">
                                <ul class="">
                                    <li class="quic-view"><button type="button" data-bs-target="#productModal-new-<?php echo $val->product_id; ?>" data-bs-toggle="modal"><i class="fa fa-search"></i>Quick view</button></li>
...
if(isset($new_arrival_products) && !empty($new_arrival_products)){
    foreach ($new_arrival_products as $val) {?>
        <div id="quickview-wrapper">
            <div class="modal fade productModaal" id="productModal-new-<?php echo $val->product_id; ?>">
                                    ...
                                    <div class="quick-add-to-cart">
                                        <div class="product-actions">
                                            <button class="button btn-cart"  title="Add to Cart"  type="submit">
                                                    <i class="fa fa-shopping-cart mycart">&nbsp;</i><span>Add to Cart</span>
                                            </button>
                                        </div>
                                    </div>
