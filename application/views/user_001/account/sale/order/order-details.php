			...
			<div class="table-responsive">
				<table style="width: 100%; max-width: 100%; margin-bottom: 20px; border-collapse: collapse; border-spacing: 0; background-color: transparent; border: 1px solid #ddd;" class="table table-bordered ">
					...
					<tr>
						...
						<th class="text-right"><b>Orignal Price</b></th>
					...
					<tr>
						...
						<td class="text-right"><?php echo ($product->unit_price < $product->orignal_price)?'<span style="font-weight:600;left: -10px; color:red;text-decoration: line-through;" class="cut_price">'.format_currency($product->orignal_price).'</span>':format_currency($product->orignal_price) ?></td>
						<?php
