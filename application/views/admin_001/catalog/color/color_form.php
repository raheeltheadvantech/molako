...
<div class="box">
    ...
    <div class="row">
        <div class="col-md-4">
            <?php
            $data = array('name'=>'code','type'=>"color",'label'=>'Color code', 'placeholder'=>'Color code', 'class'=>'form-control', 'value'=>set_value('sort', $code));
            echo form_input_1($data);
            ?>
        </div>
    </div>
    ...
    <a class="btn btn-outline-gray" href="<?php echo site_url($this->admin_url .'/'. $this->controller_dir .'/color.html');?>">Back</a>
