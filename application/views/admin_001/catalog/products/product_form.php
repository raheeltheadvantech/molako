                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-options">
                        <div class="box-body">
                            ...
                            <button type="button" onclick="load_var()" title="Add/edit options" class="btn btn-primary" data-original-title="Add/edit options" style="margin-bottom: 10px" >Refresh variation</button>
