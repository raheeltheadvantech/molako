                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" id="tr-<?php echo $val->slider_id;?>" class="<?php echo $class;?> item-slider_id" data-key="<?php echo $val->slider_id;?>">
                                        ...
                                        <td><img src="<?php echo site_url('images/slides/temp/'.$val->image);?>" width="50" style="padding:0px; border:0px solid #ddd"/></td>
                                        <td><?php echo $val->name;?></td>
                                        <td><?php echo $val->is_enabled == 1 ? 'Enabled' : 'Disabled';?></td><td><?php echo $val->is_enabled == 1 ? 'Enabled' : 'Disabled';?></td>
