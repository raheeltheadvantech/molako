            ...
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    ...
                    <div class="pull-right">
                    	<div class="btn-group">
                    	<?php if(!empty($result)):?>
                        <a href="<?php echo site_url($this->admin_url .'/'. $this->controller_dir. '/box-sort.html');?>" class="btn btn-primary">Sort</a>
                        <?php endif;?>
                        <a href="<?php echo site_url($this->admin_url .'/'. $this->controller_dir. '/box-add.html');?>" class="btn btn-primary">Add</a>
                        </div>
                    </div>
                </div><!-- Page Header -->
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" id="tr-<?php echo $val->slider_id;?>" class="<?php echo $class;?> item-slider_id" data-key="<?php echo $val->slider_id;?>">
                                        ...
                                        <td><img src="<?php echo site_url('images/boxes/file/'.$val->image);?>" width="50" style="padding:0px; border:0px solid #ddd"/></td>
...
$(document).ready(function(){
	...
	$('.btn-edit').click(function(){
		window.location = '<?php echo site_url($this->admin_url .'/'. $this->controller_dir. '/box-edit.html?id=');?>'+$(this).data('id');
	});
	...
	$('.btn-del').click(function(){
		...
		window.location = '<?php echo site_url($this->admin_url .'/'. $this->controller_dir. '/boxes/delete.html?id=');?>'+$(this).data('id');
	});
