            ...
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    ...
                    <div class="pull-right">
                    	<a href="<?php echo site_url($this->admin_url .'/'. $this->controller_dir. '/boxes.html');?>" class="btn btn-default">Back</a>
                    </div>
                </div><!-- Page Header -->
...
function save_sortable()
{
	...
	$.ajax({
		url:'<?php echo site_url($this->admin_url .'/'. $this->controller_dir. '/box/ajax/sort.html');?>',
		type:'POST',
		data:serial
	});
}
