...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-4">
                <?php
                echo form_input_1(array('name' => 'name', 'onkeydown' => 'return /^[a-zA-Z\s]*$/.test(event.key)', 'label' => 'Name', 'placeholder' => 'Geo Zone Name', 'class' => 'form-control', 'value' => set_value('name', $name)));
