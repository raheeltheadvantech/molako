			...
			<div class="table-responsive">
				<table class="table table-bordered table-hover">
					...
					<tr>
						...
						<td class="text-right">Orignal Price</td>
					...
					<tr>
						...
						<td class="text-right"><?php echo ($product->unit_price < $product->orignal_price)?'<span style="font-weight:600;left: -10px; color:red;text-decoration: line-through;" class="cut_price">'.format_currency($product->orignal_price).'</span>':format_currency($product->orignal_price) ?></td></td>
