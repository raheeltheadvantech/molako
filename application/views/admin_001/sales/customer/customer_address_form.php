...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-sm-4">
                <?php $data = array('name' => "first_name", 'onkeydown' => 'return /^[a-zA-Z\s]*$/.test(event.key)', 'label' => 'First Name', 'placeholder' => 'First Name', 'required' => 'required','class' => 'form-control','value' => set_value('first_name', $first_name)); ?>
        ...
        <div class="row">
            <div class="col-sm-4">
                <?php echo form_input_1(array('name' => 'company', 'label' => 'Company', 'onkeydown' => 'return /^[a-zA-Z\s]*$/.test(event.key)', 'placeholder' => 'Company', 'class' => 'form-control', 'value' => set_value('company', $company))); ?>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-4">
