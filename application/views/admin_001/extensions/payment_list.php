        ...
        <div class="content-wrapper">
            ...
            <div class="custom-table">
                ...
                <div class="table-meta">
                        <?php echo form_open($this->admin_folder .'/extensions/payment.html', array('class'=>'form-inline'));?>
                        <div class="leftbar">
                            <div class="custom-search">
                                ...
                                <a class="btn btn-outline-gray" href="<?php echo site_url($this->admin_folder.'/extensions/payment.html');?>">Reset</a>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive table-cols">
                        <?php if(!empty($results)): ?>
                            <table class="table table-bordered">
                                <thead>
                                <tr role="row">
                                    <th><?php echo sort_url(' ID', 'setting_id', $this->admin_folder .'/extensions/payment.html');?></th>
                                    <th>Title</th>
                                ...
                                <?php foreach ($results as $p): ?>
                                    ...
                                    <tr role="row">
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="btn-view" data-id="<?php echo $p->code; ?>" data-url="<?php echo site_url($this->admin_folder . '/' . $this->controller_dir . '/payment/Admin_'.$p->code.'/edit?id=');?>">Edit</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
