                    ...
                    <div class="table-responsive table-cols">
                        <?php if(!empty($results)): ?>
                            <table class="table table-bordered">
                                <thead>
                                <tr role="row">
                                    <th><?php echo sort_url(' ID', 'setting_id', $this->admin_folder .'/extensions/total.html');?></th>
                                    <th>Title</th>
                                    <!-- <th>Key</th>
                                    <th>Value</th>
                                    <th>Is JSON</th> -->
                                ...
                                <?php foreach ($results as $p): ?>
                                    ...
                                    <tr role="row">
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="btn-view" data-id="<?php echo $p->code; ?>" data-url="<?php echo site_url($this->admin_folder . '/' . $this->controller_dir . '/total/edit.html?id=');?>">Edit</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
