...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <h4>Stripe API Integration settings</h4>
                <hr>
                <div class="col-md-12">
                    <?php
                    $data = array('name' => $publish_key_name, 'label' => 'Stripe Publish Key', 'placeholder' => 'Stripe Publish Key', 'class' => 'form-control', 'value' => set_value($publish_key_name, $publish_key));
                    echo form_input_1($data);
                    ?>
                </div>
                <div class="col-md-12">
                    <?php
                    $data = array('name' => $secret_key_name, 'label' => 'Stripe Secret Key', 'placeholder' => 'Stripe Secret Key', 'class' => 'form-control', 'value' => set_value($secret_key_name, $secret_key));
                    echo form_input_1($data);
                    ?>
                </div>
            </div>
