...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    echo form_dropdown($status_name, $options, set_value($status, $status), 'class="form-control"');
                    ?>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-4">
                <?php
                $data = array('name' => $sort_order_name, 'label' => 'Sort Order', 'placeholder' => 'Sort Order', 'class' => 'form-control', 'value' => set_value($sort_order_name, $sort_order));
...
<div class="row" style="margin-top: 15px">
    <div class="col-sm-4 text-right">
        ...
        <a class="btn btn-outline-gray" href="<?php echo site_url($this->admin_folder . '/' . $this->controller_dir . '/total.html'); ?>">Back</a>
    </div>
</div>
