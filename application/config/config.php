...
if (strpos($ip_address, '192.168') === 0) {
    ...
    $config['base_url'] = 'http://localhost/molako';
} else { 
    $protocol = ($_SERVER['HTTPS'] === 'on') ? 'https://' : 'http://';
$host = $_SERVER['HTTP_HOST'];
$baseUrl = $protocol . $host . '/';  // Ensure a trailing slash

// Now, you can set your config array with this dynamic URL
$config['base_url'] = $baseUrl;
$config['img_url'] = 'https://www.molako.com/';$baseUrl; 
}
// die($config['base_url']);
/*
|--------------------------------------------------------------------------
...
//$config['permitted_uri_chars'] = 'a-z 0-9~%.:_\'+,-=';
$config['permitted_uri_chars'] = 'a-z 0-9~%.:_\-@';  // Add '@' or any other characters you need
...
|
*/
$config['encryption_key'] = 'sTepUheciccR5KaxeFrUdrujekmuvAcA';
...
/*----- CodeIgniter 2 Session Library (for Admin & Client) ----*/
$config['sess_expire_on_close'] = TRUE;
$config['sess_encrypt_cookie']  = TRUE;
$config['sess_use_database']    = TRUE;
$config['sess_table_name']      = 'sessions_admin';
$config['sess_match_useragent'] = TRUE;
$config['sess_flat_cookie']     = FALSE;
...
$config['csrf_token_name'] = 'sm_csrf_token';
$config['csrf_cookie_name'] = 'sm_csrf_cookie_token';
...
/*
|--------------------------------------------------------------------------
| Default image placeholder file link
|--------------------------------------------------------------------------
|
| If image is not available for an item it will be used as default image
|
*/
$config['placeholder_image'] = 'uploads/no_image.jpg';
