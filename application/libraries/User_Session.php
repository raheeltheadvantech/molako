...
class User_Session {
	...
	{
		log_message('debug', "User Session Class Initialized");
		...
		log_message('debug', "User Session routines successfully run");
	}
	...
	function sess_read()
	{
		...
		if ($session === FALSE)
		{
			log_message('debug', 'A user session cookie was not found.');
			return FALSE;
		}
		...
		else
		{
			...
			{
				log_message('error', 'The user session cookie data did not match what was expected. This could be a possible hacking attempt.');
				$this->sess_destroy();
				return FALSE;
			}
		}
...
/* Location: ./application/libraries/User_Session.php */