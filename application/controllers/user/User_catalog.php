...
class User_catalog extends User_Public_Controller {
	...
	public function deals(){		
        ...
        $this->by_category($layout_style,1);
...

	{
		...
		if (!empty($filter_ids))
		{
			...
			$total = $this->User_catalog_model->get_filter_products(array('price'=>$price,'params' => $params, 'category_id' => $category_id, 'term' => $term, 'order' => $order,'brand_id'=>$brand_id, 'sort' => $sort, 'rows' => $rows, 'per_page' => $per_page, 'filter_ids' => $filter_ids), true,$brand_slug);
			...
			$total = $this->User_catalog_model->get_products(array('price'=>$price,'brand_id'=>$brand_id,'params' => $params, 'category_id' => $category_id, 'term' => $term, 'order' => $order, 'sort' => $sort), true, $is_deals, 'test');
