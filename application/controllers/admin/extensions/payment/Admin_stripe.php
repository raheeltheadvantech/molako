...
class Admin_stripe extends Admin_Controller {
	...
	function __construct()
	{
		...
		$this->controller_name = 'admin_stripe';
        $this->view_dir = 'extensions/payment/stripe';
    ...
    {
        $data['meta_title']			= 'Stripe integration settings';
        $data['meta_keywords']		= 'Stripe integration settings';
        $data['meta_description']	= 'Stripe integration settings';

        $data['page_title']			= 'Stripe integration settings';
        $data['page_header']		= 'Stripe integration settings';
    ...
    private function form($mode = '')
    {
        ...
        {
            $this->view($this->admin_view .'/'. $this->view_dir .'/stripe_form', $data);
        }
        else
        {
            ...
            $this->admin_session->set_flashdata('message', 'Stripe settings have been saved successfully!');
