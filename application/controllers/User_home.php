...
class User_home extends User_Public_Controller {
    ...
    // { 
    	$data['scount'] = count($this->User_featured_module_model->getSpecialProducts());
		if(isset($_GET['debug']))
    	 // dd($this->db->last_query());
        $data['special_products'] = $this->User_featured_module_model->getSpecialProducts(4); // Fetch special products
         // Fetch special products
        // dd($data['special_products'][0]->images);
    ...
    public function special_products()
    { 
    	$data['scount'] = count($this->User_featured_module_model->get_new_special_products_remove());
		// if(isset($_GET['debug']))
    	 // dd($this->db->last_query());
        $data['special_products'] = $this->User_featured_module_model->get_new_special_products_remove(4); // Fetch special products
         // Fetch special products
        // dd($data['special_products'][0]->images);
        // dd($data['special_products']); 
        echo $this->load->view('special_products1', $data, true);
