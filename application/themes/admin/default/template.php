...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="/favicon.ico?v=<?php echo $this->admin_settings->site_version; ?>">
	<link rel="icon" type="image/x-icon" href="/favicon.ico?v=<?php echo $this->admin_settings->site_version; ?>">
    <title><?php echo $page_title; ?> - <?php echo $this->admin_settings->site_name; ?></title>

    <?php // CSS files ?>
    <?php if (isset($css_files) && is_array($css_files)) : ?>
        <?php foreach ($css_files as $css) : ?>
            <?php if ( ! is_null($css)) : ?>
                <link rel="stylesheet" href="<?php echo $css; ?>?v=<?php echo $this->admin_settings->site_version; ?>"><?php echo "\n"; ?>
            <?php endif; ?>
        <?php endforeach; ?>
    <?php endif; ?>
...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/"><?php echo $this->admin_settings->site_name; ?></a>
            </div>
    ...
    <footer class="sticky-footer">
        <div class="container">
            <p class="text-muted">
                ...
                | <?php echo $this->admin_settings->site_name; ?> v<?php echo $this->admin_settings->site_version; ?>
    ...
    <?php if (isset($js_files) && is_array($js_files)) : ?>
        <?php foreach ($js_files as $js) : ?>
            <?php if ( ! is_null($js)) : ?>
                <?php echo "\n"; ?><script type="text/javascript" src="<?php echo $js; ?>?v=<?php echo $this->admin_settings->site_version; ?>"></script><?php echo "\n"; ?>
            <?php endif; ?>
        <?php endforeach; ?>
    <?php endif; ?>
