...
<aside id="column-right">
	...
	<div class="list-group custom_acc">
		...
		<a href="<?php echo site_url($this->user_url_prefix . '/wishlist.html') ?>" class="list-group-item hover <?php echo $this->current_active_nav == 'wish-list' ? 'active' : '' ?>"><i class="fa fa-heart"></i> Wishlist</a>
	</div>
	<div class="list-group custom_acc">
