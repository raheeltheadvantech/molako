...
<?php $assets_img_dir = 'assets/'.site_config_item('user_assets').'/images/'; ?>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="footer-infor">
                                    <div class="footer-logo">
                                        <a href="index.html">
                                            <img src="<?php echo site_url($assets_img_dir.'logo/logo.png') ?>" alt="">
                                        </a>
                                    </div>
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                            <p>Phone: <?php echo $this->site_config->item('config_telephone'); ?></p>
                                        </li>
                                    </ul>
                                    <a href="<?= base_url('contact-us.html'); ?>" class="tf-btn btn-line">Get direction<i class="icon icon-arrow1-top-left"></i></a>
                                    <ul class="tf-social-icon d-flex gap-10">
                                        <li><a target="_blank" href="https://www.facebook.com/MolakoPeshawar?mibextid=ZbWKwL" class="box-icon w_34 round social-facebook social-line"><i class="icon fs-14 icon-fb"></i></a></li>
                                        <li><a target="_blank" href="https://m.twitter.com/login" class="box-icon w_34 round social-twiter social-line"><i class="icon fs-12 icon-Icon-x"></i></a></li>
                                        <li><a target="_blank" href="https://www.instagram.com/molako_peshawar?igsh=c3R2eTY1bDlxcWhs" class="box-icon w_34 round social-instagram social-line"><i class="icon fs-14 icon-instagram"></i></a></li>
                                        <li><a target="_blank" href="https://www.tiktok.com/@molako_the_watch?_t=8psglCY6A2p&_r=1" class="box-icon w_34 round social-tiktok social-line"><i class="icon fs-14 icon-tiktok"></i></a></li>
                                        <li><a target="_blank" href="https://www.pinterest.com" class="box-icon w_34 round social-pinterest social-line"><i class="icon fs-14 icon-pinterest-1"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6 col-12 footer-col-block">
                                ...
                                <ul class="footer-menu-list tf-collapse-content">
                                    ...
                                    <li> 
                                        <a href="<?= base_url('contact-us.html'); ?>" class="footer-menu_item">Contact Us</a>
                                    </li>
                                    <li> 
                                    ...
                                    <div class="tf-collapse-content">
                                        ...
                                        <form class="form-newsletter subscribe-form" id="" action="#" method="post" accept-charset="utf-8" data-mailchimp="true">
                                            <div class="subscribe-content">
                                                ...
                                                <input type="text" name="subscribe_name" placeholder="Name" id="subscribe_name" required="required" class="form-control">
                                        ...
                                        <div class="tf-cur">
                                            <div class="tf-currencies">
                                                <select class="image-select center style-default type-currencies">
                                                    <option data-thumbnail="<?php echo site_url($assets_img_dir.'/country/fr.svg') ?>">EUR <span>€ | France</span></option>
                                                    <option data-thumbnail="<?php echo site_url($assets_img_dir.'/country/de.svg') ?>">EUR <span>€ | Germany</span></option>
                                                    <option selected data-thumbnail="<?php echo site_url($assets_img_dir.'/country/us.svg') ?>">USD <span>$ | United States</span></option>
                                                    <option data-thumbnail="<?php echo site_url($assets_img_dir.'/country/vn.svg') ?>">VND <span>₫ | Vietnam</span></option>
                                                </select>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="footer-bottom-wrap d-flex gap-20 flex-wrap justify-content-between align-items-center">
                                    <div class="footer-menu_item">© 2024 <a href='<?php base_url(); ?>'>Molako Store</a>. All Rights Reserved</div>
                                    <div class="tf-payment">
                                        <img src="<?php echo site_url($assets_img_dir.'payments/visa.png') ?>" alt="">
                                        <img src="<?php echo site_url($assets_img_dir.'payments/visa.png') ?>" alt="">
                                        <img src="<?php echo site_url($assets_img_dir.'payments/img-2.png') ?>" alt="">
                                        <img src="<?php echo site_url($assets_img_dir.'payments/img-3.png') ?>" alt="">
                                        <img src="<?php echo site_url($assets_img_dir.'payments/img-4.png') ?>" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row-demo">
                        <div class="demo-item">
                            <a href="index.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="<?php echo site_url($assets_img_dir.'/demo/home-01.jpg') ?>" src="<?php echo site_url($assets_img_dir.'/demo/home-01.jpg') ?>" alt="home-01">
                        ...
                        <div class="demo-item">
                            <a href="home-multi-brand.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="<?php echo site_url($assets_img_dir.'/demo/home-multi-brand.jpg') ?>" src="<?php echo site_url($assets_img_dir.'/demo/home-multi-brand.jpg') ?>" alt="home-multi-brand">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                        ...
                        <div class="demo-item">
                            <a href="home-02.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="<?php echo site_url($assets_img_dir.'/demo/home-02.jpg') ?>" src="<?php echo site_url($assets_img_dir.'/demo/home-02.jpg') ?>" alt="home-02">
                                    <div class="demo-label">
                                        <span class="demo-hot">Hot</span>
                                    </div>
                                </div>
    ...
    <!-- /modal find_size -->
     ...
     <form action="<?php echo site_url('checkout/add-to-cart.html')?>" method="post" id="cart_form">
        <input type="hidden" name="item[quanitity]" value="1" id="qty"/>
        <input type="hidden" name="item[product_id]" id="pid"/>
     </form>
     <!-- add to cart end -->
...
<script type="text/javascript">
  ...
  <span class="visually-hidden">Loading...</span>
    ...
    $('#side_search').on("keypress keyup  change", function(e) {
    var str = $(this).val();
    if(str.length >= 3)
    {
        var html = `<div class="text-center mt-5"><div class="spinner-border" role="status">
...
$('.total-value').html(html);
  ...
  tot = tot + sing;
        ...
        $('.total-value').html(format_currency(tot));
    }
