...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-4">
                <?php
                echo form_input_1(array('name' => 'rate', 'label' => 'Tax Rate', 'placeholder' => 'Tax Rate', 'class' => 'form-control', 'value' => set_value('rate', $rate)));
                ?>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                $data = array('name'=>'type', 'label'=>'Type', 'class'=>'form-control',);
                echo form_dropdown_1($data, $options, set_value('type', $type));
                ?>
        ...
        <div class="row">
            <div class="col-sm-4">
                <?php
                $data	= array('name'=>'geo_zone_id', 'label'=>'Geo Zone', 'class'=>'form-control', 'id'=>'geo_zone_id');
                echo form_dropdown_1($data, $geo_zone, set_value('geo_zone_id', $geo_zone_id));
                ?>
            </div>
        </div>
