		...
		<div class="tab-content">
        	...
        	<div class="tab-pane fade active in" id="tab-general">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                         <div class="col-sm-12">
                            <?php 
                            $data = array('name'=>'config_meta_keyword', 'label'=>lang('meta_keyword'), 'placeholder'=>lang('meta_keyword'), 'class'=>'form-control', 'value'=>set_value('config_meta_keyword', $config_meta_keyword), 'rows'=>4);
                            echo form_textarea_1($data); 
                            ?>
                        </div>
                    </div>
            ...
            <div class="tab-pane fade" id="tab-mail">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <?php 
                            $data	= array('name'=>'config_mail_engine', 'label'=>lang('mail_engine'), 'class'=>'form-control', 'id'=>'config_mail_engine');
            ...
            <div class="tab-pane fade" id="tab-checkout">
                <div class="row">
                    ...
                    <div class="col-md-3 allow_purchase" style="display: none;">
