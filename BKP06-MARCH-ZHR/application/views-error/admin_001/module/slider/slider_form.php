...
<div class="box">
    ...
    <div class="row">
        <div class="col-sm-6">
        	<?php echo form_input_1(array('name'=>'title', 'label'=>'Title', 'placeholder'=>'', 'class'=>'form-control', 'value'=>set_value('title', $title))); ?>
        </div>
        <div class="col-sm-6">
        	<?php echo form_input_1(array('name'=>'name', 'label'=>'Name', 'placeholder'=>'', 'class'=>'form-control', 'value'=>set_value('name', $name))); ?>
        </div>
    </div>
