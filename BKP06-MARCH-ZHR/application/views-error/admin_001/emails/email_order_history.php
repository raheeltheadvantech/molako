...
Dear <?php echo $result->first_name.' '.$result->last_name;?>,<br>
    <br>
	<p><strong>Comment:</strong><br><?php echo $data->comment; ?></p>
    <br> 
    <p>Your order status has been changed to <?php echo $data->order_status;?> for the order <?php echo $data->order_id; ?>.</p>
    <br>
