                            ...
                            <table class="tf-table-page-cart">
                                ...
                                <tbody>
                                    ...
                                    foreach ($products as $product): ?>
                                        ...
                                        ?>
                                    <tr class="tf-cart-item file-delete tr_<?= $product->sku?>" id="tr_<?= $i ?>" unit_price="<?php echo $product->unite_price_simple; ?>" pid="<?php echo $product->product_id; ?>" sku="<?php echo $product->sku; ?>">
                                        <td class="tf-cart-item_product">
                                            <a href="<?php echo href_product($product)?>" class="img-box">
                                            ...
                                            <div class="cart-info">
                                                ...
                                                <span onclick="remove_cart('<?php echo $product->product_id; ?>')" class="remove-cart link remove">Remove</span>
                                            </div>
                                        </td>
                                        <td class="tf-cart-item_price" cart-data-title="Price">
                                            <div class="cart-price"><?php echo $product->unite_price; ?></div>
                                        </td>
                                        <td class="tf-cart-item_quantity" cart-data-title="Quantity">
                                            <div class="cart-quantity">
                                                <div class="wg-quantity">
                                                    <span class="btn-quantity " onclick="update_qty('<?= $i ?>','minus')">
                                                    ...
                                                    <input type="text" name="number" class="qty_<?= $i ?>" value="<?= $product->quantity ?>">
                                                    <span class="btn-quantity " onclick="update_qty('<?= $i ?>','plus')">
                                        ...
                                        <td class="tf-cart-item_total" cart-data-title="Total">
                                            <div class="cart-total"><?php echo $product->total; ?></div>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                    ...
                    <div class="tf-page-cart-footer">
                        <div class="tf-cart-footer-inner">
                            ...
                            <div class="tf-page-cart-checkout">
                                ...
                                <div  style="margin: 5px 0">                                <h6>Coupon</h6>                                    <?php if ($this->coupon_code && $products){?>                                        <div class="row">                                            <fieldset>                                                <input type="text" name="coupon_code" id="coupon_code" class="form-control" placeholder="Coupon Code">                                            </fieldset>                                            <div>                                            <button type="button" class="couponBtn tf-btn w-100 radius-3 btn-fill animate-hover-btn justify-content-center">Apply coupon</button>                                            </div>                                        </div>                                    <?php }?>                                 </div>
                                <div class="tf-cart-totals-discounts">
                                    <h3>Subtotal</h3>
                                    <span class="total-value"><?php echo $sub_total; ?></span>
                                </div>
                                <?php
                                if($this->user_session->userdata('coupon')):?>
                                    <div class="tf-cart-totals-discounts">
                                    <h3><i class="icon icon-delete text-danger remveCoupon" style="cursor: pointer;"></i> Discount (coupon code)</h3>
                                    <span class="total-value"><?php echo $discount; ?></span>
                                </div>
                                    <div class="tf-cart-totals-discounts">
                                        <h3>Grand Total</h3>
                                        <span class="total-value"><?php echo $grand_total; ?></span>
                                    </div>
                                    <?php endif;?>
                                <p class="tf-cart-tax">
                                ...
                                <div class="cart-checkout-btn">
                                    <a href="<?= base_url('checkout/shipping.html') ?>">
