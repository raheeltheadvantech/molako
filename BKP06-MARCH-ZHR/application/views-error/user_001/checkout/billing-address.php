	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-12 col-md-6 col-md-offset-2">
				...
				<?php echo form_open('checkout/billing/address.html');?>
				<div class="login-box">
					<div class="col-sm-12">
					...
					<div class="row">
								<div class="col-sm-12">
									<div class="alert alert-info" style="margin: 0px;">Address MUST match your PayPal account address.</div>
								</div>
							</div>
							<?php echo form_input_1(array('name'=>'address_1', 'label'=>'Address', 'placeholder'=>'Address 1', 'required' => 'required', 'class'=>'form-control', 'value'=>set_value('address_1', $address_1))); ?>
						</div>
					</div>
					...
					<div class="row hidden">
						<div class="col-md-12">
	                        ...
	                        <?php
	                        echo form_dropdown('country_id', $country_option, set_value('country_id', $country_id), 'class="form-control" id="country_id"');
	                        ?>
					...
					<div class="row">
						<div class="col-sm-12 text-right mt-3">
							<a href="<?php echo site_url($this->user_url . '/checkout/billing.html') ?>" class="btn btn-default" style="padding: 7px 10px;">Back</a>
							<button type="submit" class="btn btn-primary btn-block btn-100">Save & Continue</button>
						</div>
					</div>
				</div>
				<?php echo form_close(); ?>
