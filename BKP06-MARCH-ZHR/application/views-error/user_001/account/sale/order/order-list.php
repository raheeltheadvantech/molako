			...
			<div class="table-responsive">
				<table class="table table-hover">
					...
					<tr>
						...
						<td class="text-right"><a href="<?php echo site_url($this->user_url_prefix . '/order-history-detail.html?id='. $order->order_id) ?>" data-toggle="tooltip" title="" style="color: #fff; background-color:#2e6ed5;" class="btn btn-info" data-original-title="View"><i class="icon icon-view"></i></a></td>
					</tr>
					<?php endforeach; ?>
					<?php else: ?>
					<tr>
