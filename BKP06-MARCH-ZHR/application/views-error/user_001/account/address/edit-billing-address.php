	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-8 col-md-offset-2">
			...
			<div class="login-box contact-form">
				<div class="row">
					<div class="col-sm-12">
						<?php echo form_input_1(array('name'=>'first_name', 'label'=>'First Name', 'placeholder'=>'First Name', 'required' => 'required', 'class'=>'form-control', 'value'=>set_value('first_name', $first_name))); ?>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12">
					...
					<div class="col-sm-12">
						<div class="row">
							<div class="col-sm-offset-4 col-sm-6">
								<a href="<?php echo site_url($this->user_url_prefix . '/addresses.html') ?>" class="btn btn-default btn-block btn-100">Back</a>
							</div>
