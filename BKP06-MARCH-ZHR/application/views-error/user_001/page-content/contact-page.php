                    ...
                    <div class="tf-content-left has-mt">
                        <div class="sticky-top">
                            ...
                            <div class="mb_20">
                                ...
                                <p><?php echo $this->site_config->item('config_telephone'); ?></p>
                            </div>
                            <div class="mb_20">
                ...
                <div>
                    <?php echo form_open(site_url('contact-us.html')) ?>
                        <div class="d-flex gap-15 mb_15">
                            ...
                            <fieldset class="w-100">
                                <?php echo form_input_1(array('name'=>'phone', 'label'=>'Phone', 'placeholder'=>'Enter your phone (416) 751 5222', 'class'=>'form-control', 'value'=>set_value('phone', $phone))); ?>
                            </fieldset>
                        </div>
                        <div class="mb_15">
