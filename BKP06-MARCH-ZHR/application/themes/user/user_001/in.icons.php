@font-face {
  font-family: 'icomoon';
  src:  url('<?= base_url().$assets_dir_fs ?>icomoon.eot?ifrjc8');
  src:  url('<?= base_url().$assets_dir_fs ?>icomoon.eot?ifrjc8#iefix') format('embedded-opentype'),
    url('<?= base_url().$assets_dir_fs ?>icomoon.ttf?ifrjc8') format('truetype'),
    url('<?= base_url().$assets_dir_fs ?>icomoon.woff?ifrjc8') format('woff'),
    url('<?= base_url().$assets_dir_fs ?>icomoon.svg?ifrjc8#icomoon') format('svg');
  font-weight: normal;
  font-style: normal;
  font-display: block;
}
