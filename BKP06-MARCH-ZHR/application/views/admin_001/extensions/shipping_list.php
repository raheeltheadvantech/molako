        ...
        <div class="content-wrapper">
            ...
            <div class="custom-table">
                ...
                <div class="table-meta">
                        <?php echo form_open($this->admin_folder .'/extensions/shipping.html', array('class'=>'form-inline'));?>
                        <div class="leftbar">
                            <div class="custom-search">
                                ...
                                <a class="btn btn-outline-gray" href="<?php echo site_url($this->admin_folder.'/extensions/shipping.html');?>">Reset</a>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive table-cols">
                        <?php if(!empty($results)): ?>
                            <table class="table table-bordered">
                                <thead>
                                <tr role="row">
                                    <th><?php echo sort_url(' ID', 'setting_id', $this->admin_folder .'/extensions/shipping.html');?></th>
                                    <th>Title</th>
                                    <!-- <th>Key</th>
                                    <th>Value</th>
                                    <th>Is JSON</th> -->
                                ...
                                <?php foreach ($results as $p): ?>
                                    <tr>
                                    <tr role="row">
                                        <td><?php echo $p->setting_id; ?></td>
                                        <td><?php echo $p->code; ?></td>
                                        <!-- <td><?php echo $p->key; ?></td>
                                        <td><?php echo $p->value; ?></td>
                                        <td><?php if($p->is_json == '1') { echo 'Yes'; }else{ echo 'No'; } ?></td> -->
                                        <td>
                                            <a href="javascript:void(0);" class="btn-view" data-id="<?php echo $p->code; ?>" data-url="<?php echo site_url($this->admin_folder . '/' . $this->controller_dir . '/shipping/Admin_'.$p->code.'/edit?id=');?>">Edit</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
