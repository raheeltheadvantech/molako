...
<div class="box">
    ...
    <a class="btn btn-outline-gray" href="<?php echo site_url($this->admin_url .'/'. $this->controller_dir .'/boxes.html');?>">Back</a>
...
$(document).ready(function(){
	...
	$('.btn-edit').click(function(){
		window.location = '<?php echo site_url($this->admin_folder .'/'. $this->controller_dir. '/box-edit.html?id=');?>'+$(this).data('id');
	});
...
<script>
    ...
    var dropzone = new Dropzone('#dropzone', {
        addRemoveLinks: true,
        dictRemoveFile: "×",
        url: '<?php echo site_url($this->admin_url .'/'. $this->controller_dir .'/box/simple-image-uploader.html'); ?>',
        maxFilesize: 5,
    ...
    var existingFiles = [
        <?php if(!empty($image)){?>
        {name: '<?php echo $image; ?>', size: 1, path: '<?php echo site_url('images/boxes/file/');?>', youtube_url: ''},
        <?php } ?>
    ];
