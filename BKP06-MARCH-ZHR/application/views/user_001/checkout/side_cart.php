                        ...
                        <div class="tf-mini-cart-main">
                            ...
                            <div class="tf-mini-cart-sroll">
                                ...
                                <div class="tf-mini-cart-items">
                                    ...
                                    <div class="tf-mini-cart-item tr_<?= $product->sku?>">
                                        ...
                                        <div class="tf-mini-cart-info" id="tr_<?= $i ?>" unit_price="<?php echo $product->unite_price_simple; ?>" pid="<?php echo $product->product_id; ?>" sku="<?php echo $product->sku; ?>" >
...
<div class="tf-mini-cart-btns">
                                                ...
                                                <!-- <div class="wg-quantity small">
                                                    ...
                                                    <span class="btn-quantity " onclick="update_qty('<?= $i ?>','minus')">-</span>

                                                    <input type="text" name="number" class="qty_<?= $i ?>" value="<?= $product->quantity ?>">

                                                    <span class="btn-quantity " onclick="update_qty('<?= $i ?>','plus')">+</span>

                                                </div> -->

                                                <div style="    cursor: pointer;" class="tf-mini-cart-remove"  onclick="remove_cart('<?php echo $product->product_id; ?>','<?php echo $product->product_option_value_id ?>')">Remove</div>
                        ...
                        <div class="tf-mini-cart-bottom">
                            ...
                            <div class="tf-mini-cart-bottom-wrap">
                                ...
                                <div class="tf-cart-totals-discounts">
                                    ...
                                    <div class="tf-totals-total-value fw-6 total-value"><?= $total_price

                                     ?></div>

                                </div>

                                <div class="tf-cart-tax">Taxes and <a href="<?php echo base_url('pages/shipping.html')?>">shipping</a> calculated at checkout</div>
                                ...
                                <div class="tf-cart-checkbox">
                                    ...
                                    <label for="CartDrawer-Form_agree">
                                        ...
                                        <a href="<?php echo base_url('pages/terms-conditions.html')?>" title="Terms of Service">terms and conditions</a>
